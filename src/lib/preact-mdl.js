...
export class CheckBox extends MaterialComponent {
	...
	mdlRender(props) {
		...
		return (
			<label {...props}>
				<input type="checkbox" class="mdl-checkbox__input" checked={ props.checked }
					   disabled={ props.disabled } {...evt} />
...
export class Radio extends MaterialComponent {
	...
	mdlRender(props) {
		return (
			<label {...props}>
				<input type="radio" class="mdl-radio__button" name={ props.name } value={ props.value }
...
export class IconToggle extends MaterialComponent {
	...
	mdlRender(props) {
		return (
			<label {...props}>
				<input type="checkbox" class="mdl-icon-toggle__input" checked={ props.checked }
...
export class Switch extends MaterialComponent {
	...
	mdlRender({ ...props }) {
		...
		return (
			<label {...props}>
				<input type="checkbox" class="mdl-switch__input" checked={ props.checked }
					   disabled={ props.disabled } {...evt} />
